      ...
      <div className="custom-screen text-gray-300 justify-between gap-24 lg:flex">
        <div className="max-w-xl">
          <h2 className="text-white text-3xl font-semibold sm:text-4xl">
            Amplify Your Reach with Smart Solutions
          </h2>
          <p className="mt-3">
            Our revolutionary approach to web app development ensures your
            project gets the attention it deserves. We provide tailored packages
